...
def main():
    weather_files = [
        r'E:\amanca\data\kecamatanforecast-banten_ndf.csv',
        r'E:\amanca\data\kecamatanforecast-jakarta_ndf.csv',
        r'E:\amanca\data\kecamatanforecast-jawabarat_ndf.csv',
       
    ]
    location_file = r'E:\amanca\data\kecamatan_geofeatures.csv'
    output_files = [
        r'E:\amanca\data\merged_data_banten_ndf.csv',
        r'E:\amanca\data\merged_data_jakarta_ndf.csv',
        r'E:\amanca\data\merged_data_jawabarat_ndf.csv',
      
    ]
    json_files = [
        r'E:\amanca\data\outputbanten_ndf.json',
        r'E:\amanca\data\outputjakarta_ndf.json',
        r'E:\amanca\data\outputjawabarat_ndf.json',
