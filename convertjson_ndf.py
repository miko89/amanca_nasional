...
def main():
    weather_files = [
        ...
        r'E:\amanca\data\kecamatanforecast-kalteng.csv'
    ]
    ...
    output_files = [
        ...
        r'E:\amanca\data\merged_data_kalteng.csv'
    ]
    json_files = [
        r'E:\amanca\data\outputbanten.json',
        r'E:\amanca\data\outputjakarta.json',
        r'E:\amanca\data\outputjawabarat.json',
        r'E:\amanca\data\outputkalteng.json'
